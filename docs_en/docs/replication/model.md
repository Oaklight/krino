...
Open typed decision model replication. Implements the operational pipeline identified through [black-box probing](../probing/architecture.md) of TypeSafe's Jev:
...
See [Model Replication Results](results.md) for full analysis.
